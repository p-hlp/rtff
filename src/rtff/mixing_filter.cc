...
//
//uint32_t MixingFilter::window_size() const { return impl_->window_size(); }
...
//}
//
//void MixingFilter::Write(const Waveform *buffer) {
...
//}
//
//void MixingFilter::Read(Waveform *buffer) {
//  auto frame_count = buffer->frame_count();
...
//              buffer->data(channel_idx) + frame_count, 0);
//  }
//}
//
